...
/**
 * Sesión válida y (`is_superadmin` o `managed_module_slugs` incluye Sistemas).
 * Rutas `sistemas/module-settings/*`.
 */
@Injectable()
export class SistemasModuleAdminGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    throw new ForbiddenException({
      message: 'Solo superadmin o administradores del módulo Sistemas',
    });
  }
}
